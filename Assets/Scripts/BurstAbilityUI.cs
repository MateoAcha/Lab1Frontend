...
public class BurstAbilityUI : MonoBehaviour
{
    ...
    private void LateUpdate()
    {
        ...
        float progress = player.BurstCooldownProgress01;
    ...
    private void BuildUI()
    {
        ...
        const string iconName = "BurstAbilityIcon";
